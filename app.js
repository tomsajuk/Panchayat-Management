...
//controllers
var tlf_details = require('./api/controllers/tlf.js');
...
var tlf_meeting = require('./api/controllers/tlf_meeting.js');
...
app.use('/api/meeting/tlf', tlf_meeting);
